    ...
    <div class="admin-layout adminlte-layout">
        <aside class="admin-sidebar">
            ...
            <nav class="admin-nav" aria-label="Navigasi admin">
                ...
                <a class="<?= strpos($current_path, 'admin/sertifikasi') === 0 ? 'is-active' : ''; ?>" href="<?= site_url('admin/sertifikasi'); ?>"><span>SF</span>Data Sertifikasi</a>
                <a class="<?= strpos($current_path, 'admin/jadwal_training') === 0 ? 'is-active' : ''; ?>" href="<?= site_url('admin/jadwal_training'); ?>"><span>JT</span>Jadwal Training</a>
